...
const ThingsToDoHK = () => {
  ...
  const { cards, handleCardChange, handleSubmit } = useSectionData('thingstoSee', initialCards)
  ...
  return (
    <div>
      <form onSubmit={onSubmit} className='shadow-lg px-6 py-6 rounded-md'>
        <h2 className='font-bold text-19px my-2'>Things to see and do in Hong Kong :</h2>
