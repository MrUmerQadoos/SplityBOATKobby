...
const rows = [
  createData(
    '/images/avatars/placeholderimage.jpg',
    'Release Wanaka - Brownston Street',
...
const AllAccomodationPosts = ({ title }) => {
  return (
    <div className='shadow-lg px-6 py-6 rounded-md'>
      <div className='flex items-center justify-end mb-3'>
        <Button href={'add-accommodation'} fullWidth variant='outlined' className='w-[120px] float-end'>
          Add New
        </Button>
      </div>
...
export default AllAccomodationPosts
