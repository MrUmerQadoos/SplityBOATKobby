...
const TopPlacesToVisitPlan = () => {
  ...
  const { cards, handleCardChange, handleSubmit } = useSectionData('topplacestovistPlan', initialCards)
  ...
  return (
    <div>
      <form onSubmit={onSubmit} className='shadow-lg px-6 py-6 rounded-md'>
        <h2 className='font-bold text-19px my-2'>Top places to visit:</h2>
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} sm={4} md={4} lg={6}>
            <LandscapceCard index={3} formData={cards[3]} onFormChange={handleCardChange} />
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={6}>
            <LandscapceCard index={4} formData={cards[4]} onFormChange={handleCardChange} />
          </Grid>
          <Grid item xs={12}>
            <Button
              type='submit'
...
export default TopPlacesToVisitPlan
