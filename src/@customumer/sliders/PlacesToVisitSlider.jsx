...
const PlacesToVisitSlider = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      setIsLoading(true)
      try {
        const response = await axios.get('/api/placestovisitslider') // API call to fetch existing images
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/placestovisitslider', payload)
