...
const FindAccommodationSlider = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      setIsLoading(true)
      try {
        const response = await axios.get('/api/findaccommodationslider') // API call to fetch existing images
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/findaccommodationslider', payload)
...
export default FindAccommodationSlider
