...
const PlanYourTripSlider = () => {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      setIsLoading(true)
      try {
        const response = await axios.get('/api/planyourtripslider') // API call to fetch existing images
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post('/api/planyourtripslider', payload)
...
export default PlanYourTripSlider
